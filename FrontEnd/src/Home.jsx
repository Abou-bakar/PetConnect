    ...
    <div className="min-h-screen bg-[#F9F9F9]">
      ...
      <header className="flex flex-wrap justify-between items-center px-6 md:px-20 py-0 bg-[#F9F9F9] text-[#65cadc]">
        ...
        <nav className="flex space-x-6 font-semibold">
          <Link to="/Home" className="hover:text-[#45A1C1]">
            Home
          </Link>
          <Link to="/petadoption" className="hover:text-[#45A1C1]">
            Adoption
          </Link>
          <Link to="/pethealth" className="hover:text-[#45A1C1]">
            Health Tracker
          </Link>
          <Link to="/Petsocial" className="hover:text-[#45A1C1]">
            Social Network
          </Link>
          <Link to="/UserPetEvents" className="hover:text-[#45A1C1]">
            Events
          </Link>
          {isUser && (
            <Link to="/PetProfile" className="hover:text-[#45A1C1]">
              Profile
            </Link>
          )}
          {isAdmin && (
            <Link to="/admin" className="hover:text-[#45A1C1]">
              Admin Panel
            </Link>
          )}
      ...
      <main className="flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-32 bg-[#65cadc]">
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h1 className="text-4xl md:text-5xl font-bold text-[#F9F9F9] mb-4">
            Your One-Stop Pet Companion
          </h1>
          <p className="text-lg text-gray-700 mb-6">
            Adoption, Health Tracking, Events, and more.
          </p>
          <a
            href="#what-we-offer"
      ...
      {/* Features Section */}
      <section
        className="px-6 py-20 bg-gray-100 min-h-screen pt-7"
        id="what-we-offer"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
            ...
            <div>
              ...
              <ul>
                ...
                <li>
                  <a href="/ContactForm" className="hover:text-[#45A1C1]">
                    Contact Form
                  </a>
                </li>
              </ul>
